...
### HTML,CSS,JAVASCRIPT,JAVA,PYTHON,Numpy,Pandas,Matplotlib,Beautifulsoup,Selenium<BR>
...
@character: <b>logical thinking</b>.  always looking for the shortest possible way to solve issues even routine errands. ex: Cut accounting report lead time from 2hr to 30 sec             using excel programming(VBA).<br>
